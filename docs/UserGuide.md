...
`pvalue_histogram(pvals: Union[pandas.core.series.Series, ndarray, List[float]], bins: int = 50, save_path: Union[str, pathlib.Path, NoneType] = None) -> matplotlib.figure.Figure`
